...
const jt = vueExports.ref(0), te = vueExports.ref(1), q = vueExports.ref({}), ie = vueExports.ref(0), Wt = vueExports.ref({}), tt = {}, we = typeof window > "u";
function co(e, t, r) {
...
const lr = vueExports.ref(0), Mr = vueExports.ref(null);
function mo(e, t) {
  var m;
  lr.value++;
...
const Si = vueExports.ref({}), Oi = (e) => Si.value[e], go = (e) => Object.keys(Oi.value[e]).length > 0, $i = vueExports.ref({}), yo = (e) => $i.value[e], Ei = vueExports.ref({}), bo = (e) => Ei.value[e], rt = vueExports.ref([]);
function wo(e) {
  rt.value.push(e);
}
const So = vueExports.computed(() => uo(rt.value));
function Oo(e) {
  rt.value[e].dismissed = true, rt.value[e].html = null;
}
const Nr = vueExports.ref(null);
...
const v = {
  ...
  currentStack: ie,
  stackType: xo,
  pageVisitId: vueExports.computed(() => q.value.pageVisitId),
  dynamicVisitId: vueExports.computed(() => q.value.dynamicVisitId),
  isSsr: we,
...
const ue = {
  ...
  setup(e) {
    ...
    return v.setOnHead((d) => {
      ...
      n.value[v.currentStack.value] && (a.value = false), n.value[v.currentStack.value] = { html: d, type: f }, vueExports.nextTick(() => {
        a.value = true;
      });
    ...
    }), (d, f) => (vueExports.openBlock(), vueExports.createElementBlock("div", null, [
      vueExports.unref(v).isSsr ? (vueExports.openBlock(), vueExports.createBlock(ue, {
      ...
      (vueExports.openBlock(true), vueExports.createElementBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(v).currentStack.value, (p) => (vueExports.openBlock(), vueExports.createBlock(ue, {
        key: `modal.${p}`,
        type: n.value[p].type,
        html: n.value[p].html,
        stack: p,
        "on-top-of-stack": vueExports.unref(v).currentStack.value === p,
        animate: a.value,
        onClose: (g) => c(p)
      }, null, 8, ["type", "html", "stack", "on-top-of-stack", "animate", "onClose"]))), 128)),
      i.value ? (vueExports.openBlock(), vueExports.createBlock(No, {
        key: 2,
        html: i.value,
        onClose: u
...
function cr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
  ...
  if (n) {
    ...
    for (let [d, f] of Object.entries(n))
      typeof f == "boolean" && (m = true), f === true && h.push(d);
...
`)].join(`
`));
      let d = Ri((a = m.props) != null ? a : {}, l), f = vueExports.cloneVNode(m, d);
      for (let p in d)
...
function Di(e) {
  return e.flatMap((t) => t.type === vueExports.Fragment ? Di(t.children) : [t]);
}
function Ri(...e) {
  if (e.length === 0)
    return {};
...
function Lt(e, t, { sorted: r = true, relativeTo: n = null, skipElements: i = [] } = {}) {
  ...
  let l = (() => {
    ...
    if (t & 8)
      return o.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), c = t & 32 ? { preventScroll: true } : {}, m = 0, h = o.length, d;
  do {
    if (m >= h || m + h <= 0)
      return 0;
    let f = u + m;
...
function dr(e, t, r) {
  $t.isServer || vueExports.watchEffect((n) => {
    document.addEventListener(e, t, r), n(() => document.removeEventListener(e, t, r));
  });
}
function tu(e, t, r = vueExports.computed(() => true)) {
  function n(s, a) {
...
let yr = vueExports.defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(e, { slots: t, attrs: r }) {
  return () => {
...
function Hi(e, t, r, n) {
  $t.isServer || vueExports.watchEffect((i) => {
...
let pt = Object.assign(vueExports.defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: vueExports.ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = vueExports.ref(null);
  n({ el: i, $el: i });
  let s = vueExports.computed(() => ot(i));
  su({ ownerDocument: s }, vueExports.computed(() => Boolean(e.features & 16)));
  let a = au({ ownerDocument: s, container: i, initialFocus: vueExports.computed(() => e.initialFocus) }, vueExports.computed(() => Boolean(e.features & 2)));
  ou({ ownerDocument: s, container: i, containers: e.containers, previousActiveElement: a }, vueExports.computed(() => Boolean(e.features & 8)));
  let o = nu();
  function l(h) {
    let d = de(i);
    !d || ((f) => f())(() => {
      Y(o.value, { [mt.Forwards]: () => {
        Lt(d, Te.First, { skipElements: [h.relatedTarget] });
      }, [mt.Backwards]: () => {
        Lt(d, Te.Last, { skipElements: [h.relatedTarget] });
      } });
    });
  }
  let u = vueExports.ref(false);
  function c(h) {
    h.key === "Tab" && (u.value = true, requestAnimationFrame(() => {
      u.value = false;
    }));
  }
  function m(h) {
    ...
    p instanceof HTMLElement && p.dataset.headlessuiFocusGuard !== "true" && (Wi(f, p) || (u.value ? Lt(de(i), Y(o.value, { [mt.Forwards]: () => Te.Next, [mt.Backwards]: () => Te.Previous }) | Te.WrapAround, { relativeTo: h.target }) : h.target instanceof HTMLElement && Ze(h.target)));
  }
  return () => {
    let h = {}, d = { ref: i, onKeydown: c, onFocusout: m }, { features: f, initialFocus: p, containers: g, ...S } = e;
    return vueExports.h(vueExports.Fragment, [Boolean(f & 4) && vueExports.h(yr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: Mt.Focusable }), X({ ourProps: d, theirProps: { ...t, ...S }, slot: h, attrs: t, slots: r, name: "FocusTrap" }), Boolean(f & 4) && vueExports.h(yr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: Mt.Focusable })]);
  };
} }), { features: Ui });
  ...
  return vueExports.onMounted(() => s.value = true), vueExports.onUnmounted(() => s.value = false), vueExports.onMounted(() => {
    vueExports.watch([t, r, n], (a, o) => {
      ...
      !l || iu(() => {
        ...
        if (!s.value)
          return;
        let m = de(r), h = (u = e.value) == null ? void 0 : u.activeElement;
        if (m) {
          if (m === h) {
            i.value = h;
            return;
...
function lu(e, t = vueExports.ref(true)) {
...
function uu() {
  return vueExports.inject(zi, false);
}
let br = vueExports.defineComponent({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: false } }, setup(e, { slots: t, attrs: r }) {
  return vueExports.provide(zi, e.force), () => {
    let { force: n, ...i } = e;
...
let Gi = vueExports.defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
  let n = vueExports.ref(null), i = vueExports.computed(() => ot(n)), s = uu(), a = vueExports.inject(Xi, null), o = vueExports.ref(s === true || a == null ? cu(n.value) : a.resolveTarget());
  return vueExports.watchEffect(() => {
    ...
    return vueExports.h(vueExports.Teleport, { to: o.value }, X({ ourProps: l, theirProps: e, slot: {}, attrs: r, slots: t, name: "Portal" }));
  };
} }), Xi = Symbol("PortalGroupContext"), du = vueExports.defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
  let n = vueExports.reactive({ resolveTarget() {
    return e.target;
  } });
  return vueExports.provide(Xi, n), () => {
    let { target: i, ...s } = e;
...
function pu({ type: e, enabled: t, element: r, onUpdate: n }) {
  ...
  vueExports.onMounted(() => {
    ...
    t.value && s(1, e, r);
  }), vueExports.provide(Ki, s);
}
let Yi = Symbol("DescriptionContext");
function hu() {
  let e = vueExports.inject(Yi, null);
  if (e === null)
    throw new Error("Missing parent");
  return e;
}
function mu({ slot: e = vueExports.ref({}), name: t = "Description", props: r = {} } = {}) {
  ...
  return vueExports.provide(Yi, { register: i, slot: e, name: t, props: r }), vueExports.computed(() => n.value.length > 0 ? n.value.join(" ") : void 0);
}
vueExports.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Xe()}` } }, setup(e, { attrs: t, slots: r }) {
  ...
  return vueExports.onMounted(() => vueExports.onUnmounted(n.register(e.id))), () => {
    let { name: i = "Description", slot: s = vueExports.ref({}), props: a = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(a).reduce((c, [m, h]) => Object.assign(c, { [m]: vueExports.unref(h) }), {}), id: o };
...
function Et(e) {
  let t = vueExports.inject(Sr, null);
  if (t === null) {
...
let Pt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Jr = vueExports.defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: Pt }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Xe()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  var s;
  let a = vueExports.ref(false);
  vueExports.onMounted(() => {
    a.value = true;
  });
  let o = vueExports.ref(0), l = Yr(), u = vueExports.computed(() => e.open === Pt && l !== null ? Y(l.value, { [He.Open]: true, [He.Closed]: false }) : e.open), c = vueExports.ref(/* @__PURE__ */ new Set()), m = vueExports.ref(null), h = vueExports.ref(null), d = vueExports.computed(() => ot(m));
  ...
  let f = vueExports.computed(() => a.value && u.value ? 0 : 1), p = vueExports.computed(() => f.value === 0), g = vueExports.computed(() => o.value > 1), S = vueExports.inject(Sr, null) !== null, I = vueExports.computed(() => g.value ? "parent" : "leaf");
  lu(m, vueExports.computed(() => g.value ? p.value : false)), pu({ type: "Dialog", enabled: vueExports.computed(() => f.value === 0), element: m, onUpdate: (w, $, E) => {
    if ($ === "Dialog")
      return Y(w, { [wr.Add]() {
  ...
  let A = mu({ name: "DialogDescription", slot: vueExports.computed(() => ({ open: u.value })) }), x = vueExports.ref(null), O = { titleId: x, panelRef: vueExports.ref(null), dialogState: f, setTitleId(w) {
    x.value !== w && (x.value = w);
  }, close() {
    t("close", false);
  } };
  vueExports.provide(Sr, O);
  function b() {
    var w, $, E;
    return [...Array.from(($ = (w = d.value) == null ? void 0 : w.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? $ : []).filter((T) => !(T === document.body || T === document.head || !(T instanceof HTMLElement) || T.contains(de(h)) || O.panelRef.value && T.contains(O.panelRef.value))), (E = O.panelRef.value) != null ? E : m.value];
  }
  return tu(() => b(), (w, $) => {
    O.close(), vueExports.nextTick(() => $ == null ? void 0 : $.focus());
  }, vueExports.computed(() => f.value === 0 && !g.value)), Hi((s = d.value) == null ? void 0 : s.defaultView, "keydown", (w) => {
    w.defaultPrevented || w.key === Bi.Escape && f.value === 0 && (g.value || (w.preventDefault(), w.stopPropagation(), O.close()));
  }), vueExports.watchEffect((w) => {
    var $;
    if (f.value !== 0 || S)
      return;
    let E = d.value;
    ...
    return vueExports.h(br, { force: true }, () => [vueExports.h(Gi, () => vueExports.h(du, { target: m.value }, () => vueExports.h(br, { force: false }, () => vueExports.h(pt, { initialFocus: E, containers: c, features: p.value ? Y(I.value, { parent: pt.features.RestoreFocus, leaf: pt.features.All & ~pt.features.FocusLock }) : pt.features.None }, () => X({ ourProps: _, theirProps: T, slot: L, attrs: r, slots: n, visible: f.value === 0, features: Bt.RenderStrategy | Bt.Static, name: "Dialog" }))))), vueExports.h(yr, { features: Mt.Hidden, ref: h })]);
  };
} });
...
vueExports.defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Xe()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = Et("DialogBackdrop"), s = vueExports.ref(null);
  return n({ el: s, $el: s }), vueExports.onMounted(() => {
    if (i.panelRef.value === null)
      throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
    let { id: a, ...o } = e, l = { id: a, ref: s, "aria-hidden": true };
    return vueExports.h(br, { force: true }, () => vueExports.h(Gi, () => X({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
  };
} });
let Zr = vueExports.defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Xe()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
function Su() {
  return vueExports.inject(en, null) !== null;
}
function Ou() {
  let e = vueExports.inject(en, null);
  if (e === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e;
}
function $u() {
  let e = vueExports.inject(tn, null);
  if (e === null)
    throw new Error("A <TransitionChild /> is used but it is missing a parent <TransitionRoot />.");
  return e;
}
...
let Ji = Bt.RenderStrategy, lt = vueExports.defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  if (!Su() && zl())
    return () => vueExports.h(ut, { ...e, onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave") }, n);
  let s = vueExports.ref(null), a = vueExports.ref("visible"), o = vueExports.computed(() => e.unmount ? _e.Unmount : _e.Hidden);
  i({ el: s, $el: s });
  let { show: l, appear: u } = Ou(), { register: c, unregister: m } = $u(), h = { value: true }, d = Xe(), f = { value: false }, p = Qi(() => {
  ...
  return vueExports.onMounted(() => {
    vueExports.watch([l], ($, E, T) => {
      w(T), h.value = false;
    }, { immediate: true });
  }), vueExports.provide(tn, p), Gl(vueExports.computed(() => Y(a.value, { visible: He.Open, hidden: He.Closed }))), () => {
    let { appear: $, show: E, enter: T, enterFrom: _, enterTo: L, entered: k, leave: ee, leaveFrom: j, leaveTo: P, ...R } = e, le = { ref: s }, U = { ...R, ...u && l && $t.isServer ? { class: vueExports.normalizeClass([R.class, ...g, ...S]) } : {} };
    return X({ theirProps: U, ourProps: le, slot: {}, slots: n, attrs: r, features: Ji, visible: a.value === "visible", name: "TransitionChild" });
  };
} }), Eu = lt, ut = vueExports.defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
  let i = Yr(), s = vueExports.computed(() => e.show === null && i !== null ? Y(i.value, { [He.Open]: true, [He.Closed]: false }) : e.show);
  vueExports.watchEffect(() => {
    if (![true, false].includes(s.value))
      throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
  });
  let a = vueExports.ref(s.value ? "visible" : "hidden"), o = Qi(() => {
    a.value = "hidden";
  ...
  }), vueExports.provide(tn, o), vueExports.provide(en, u), () => {
    let c = ji(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), m = { unmount: e.unmount };
    return X({ ourProps: { ...m, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [vueExports.h(Eu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...m, ...c }, n.default)] }, attrs: {}, features: Ji, visible: a.value === "visible", name: "Transition" });
  };
} });
const xu = {
  props: {
...
function rn(e, t, r) {
  var n, i, s, a, o, l, u = 0, c = false, m = false, h = true;
  if (typeof e != "function")
    throw new TypeError(Nu);
  t = $r(t) || 0, z(r) && (c = !!r.leading, m = "maxWait" in r, s = m ? Vu($r(r.maxWait) || 0, t) : s, h = "trailing" in r ? !!r.trailing : h);
  function d(b) {
    var w = n, $ = i;
...
function it(e, t, r) {
  ...
  var a = Ue(e) ? Z(e) : window, o = a.visualViewport, l = !ns() && r, u = (n.left + (l && o ? o.offsetLeft : 0)) / i, c = (n.top + (l && o ? o.offsetTop : 0)) / s, m = n.width / i, h = n.height / s;
  return {
    width: m,
    height: h,
    top: c,
...
function ln(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, s = r.strategy, a = s === void 0 ? e.strategy : s, o = r.boundary, l = o === void 0 ? Ju : o, u = r.rootBoundary, c = u === void 0 ? as : u, m = r.elementContext, h = m === void 0 ? ht : m, d = r.altBoundary, f = d === void 0 ? false : d, p = r.padding, g = p === void 0 ? 0 : p, S = $c(typeof g != "number" ? g : Ec(g, tr)), I = h === ht ? Zu : ht, A = e.rects.popper, x = e.elements[f ? I : h], O = Oc(Ue(x) ? x : x.contextElement || Le(e.elements.popper), l, c, a), b = it(e.elements.reference), w = ls({
    reference: b,
    element: A,
    strategy: "absolute",
    placement: i
  }), $ = Tr(Object.assign({}, A, w)), E = h === ht ? $ : b, T = {
...
function Vc(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, m = r.padding, h = r.tether, d = h === void 0 ? true : h, f = r.tetherOffset, p = f === void 0 ? 0 : f, g = ln(t, {
    boundary: l,
    rootBoundary: u,
    padding: m,
    altBoundary: c
...
function Xc(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, m = r.rootBoundary, h = r.altBoundary, d = r.flipVariations, f = d === void 0 ? true : d, p = r.allowedAutoPlacements, g = t.options.placement, S = ge(g), I = S === g, A = l || (I || !f ? [Dt(g)] : Gc(g)), x = [g].concat(A).reduce(function(Ye, $e) {
...
function Jc(e, t, r, n, i, s) {
  ...
  return vueExports.openBlock(), vueExports.createBlock(a, {
    ...
    default: vueExports.withCtx(() => [
      ...
      vueExports.createElementVNode("div", Qc, [
...
function ds(e, t, r, n, i, s) {
  ...
  if (u && c)
    return u == t && c == e;
  var m = -1, h = true, d = r & md ? new Vt() : void 0;
...
function rf(e, t, r, n, i, s) {
  ...
  return h ? (s || (s = new ye()), Hd(e, t, r, n, i, s)) : false;
}
...
function af(e, t, r, n) {
  ...
  for (; ++i < s; ) {
    ...
    if (a && o[2]) {
      ...
      if (n)
        var h = n(u, c, l, e, t, m);
      if (!(h === void 0 ? rr(c, u, nf | sf, n, m) : h))
        return false;
    }
  }
  return true;
...
function Tf(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", xf, [
    vueExports.renderSlot(e.$slots, "default", {
...
function qf(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", Ff, [
...
function op(e, t, r, n, i, s) {
  return vueExports.openBlock(), vueExports.createElementBlock("div", ap, [
    vueExports.renderSlot(e.$slots, "default")
  ], 512);
}
